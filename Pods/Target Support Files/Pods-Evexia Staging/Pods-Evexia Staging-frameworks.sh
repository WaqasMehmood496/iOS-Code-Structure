...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RookAppleHealth/RookAppleHealth.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RookConnectTransmission/RookConnectTransmission.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RookSDK/RookSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RookUsersSDK/RookUsersSDK.framework"
fi
